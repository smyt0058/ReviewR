...
//        let wbuttons = wModal.getElementsByTagName("button");
        ...
        let dButton = document.getElementById("deleteBtn");
    ...
    displayList: function () {
        ...
        app.data.reviews.forEach(function (element, index) {
            ...
            let setRating = rateDiv.getElementsByClassName("star");
            for (let j = 0; j < element.rating; j++) {
                setRating[j].classList.add("rated");
            }
...
        }
    ...
    deleteModalScreen: function () {
        ...
        let review = app.data.reviews[app.currentIndex];
        console.log(review);
        imgDiv.innerHTML = "";
        img.src = review.img;
    ...
    eventStars: function () {
        ...
        let netRating = document.getElementById("rating");
